...
public class Camera extends Component{
	    ...
	    public void takeStill() {
	        takeStill(PicConfig.Builder.newInstance().outputPath("/home/audrey/Images/image.jpg").build());
	    }
	     ...
	     */
	    public void takeVid() {
	        takeVid(VidConfig.Builder.newInstance().outputPath("/home/audrey/Vidéos/video.h264").recordTime(5000).build());
	    }
	     ...
	     */
	    public void callBash(ProcessBuilder processBuilder) throws IOException, InterruptedException {
	    ...
	    private void init(){
	    	...
	    	System.out.println("initialisation of camera");

	        ProcessBuilder processBuilder = new ProcessBuilder();
	        processBuilder.command("bash", "-c", "raspistill");
	    ...
	    public static class PicConfig {
	        ...
	        public String asCommand(){
	            StringBuilder command = new StringBuilder("raspistill");
	            if (useDate){
	    ...
	    public static class VidConfig {
	         ...
	         */
	        public String asCommand(){
	            StringBuilder command = new StringBuilder("raspivid -t " + recordTime);
	            if (useDate){
