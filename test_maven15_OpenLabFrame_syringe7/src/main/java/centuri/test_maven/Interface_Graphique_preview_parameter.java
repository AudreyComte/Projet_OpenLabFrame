	...
	public Interface_Graphique_preview_parameter() throws SerialException, IOException, InterruptedException {
		...
		panel_Moving.add(panel, BorderLayout.CENTER);
				...
				panel_25.add(btnNewButton_4);
						...
						panel_18.add(panel_33);
						
						JPanel panel_32 = new JPanel();
						panel_18.add(panel_32);
						panel_32.setLayout(new GridLayout(5, 1, 0, 0));
						
						JPanel panel_27 = new JPanel();
						panel_18.add(panel_27);
						panel_27.setLayout(new GridLayout(2, 2, 5, 0));
						...
						JLabel lblNewLabel = new JLabel("Mouvement");
		...
		panel_42.setLayout(new GridLayout(1, 2, 50, 0));
		...
		DefaultListModel<String> listData_2 = new DefaultListModel();
		
		JPanel panel_22 = new JPanel();
		panel_4.add(panel_22, BorderLayout.CENTER);
		panel_22.setLayout(new GridLayout(1, 1, 0, 0));
		
		JList list_2 = new JList(listData_2);
