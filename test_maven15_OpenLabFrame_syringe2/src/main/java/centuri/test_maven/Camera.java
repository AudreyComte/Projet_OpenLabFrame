...
public class Camera extends Component{
	     ...
	     */
	    public void takeVid() {
	        takeVid(VidConfig.Builder.newInstance().outputPath("/home/audrey/Vidéos/video.h264").recordTime(1).build());
	    }
	    ...
	    public static class PicConfig {
	        ...
	        public String asCommand(){
	            StringBuilder command = new StringBuilder("raspistill -p '200,10,450,450' ");
	            if (useDate){
	            ...
	            if (delay != 0){
	                command.append(" -t  50").append(delay);}
	            if (width != 0){
	    ...
	    public static class VidConfig {
	         ...
	         */
	        public String asCommand(){
	            StringBuilder command = new StringBuilder("raspivid -p '200,10,450,450' -w 1000 -h 1000 -t " + recordTime);
	            if (useDate){
