...
// éléments sous forme de chaînes de caractères.
		...
		tabbedPane.addTab("Preview", null, panel_Preview, null);
		panel_Preview.setLayout(new BorderLayout(0, 0));

		JPanel panel_10 = new JPanel();
		panel_Preview.add(panel_10, BorderLayout.NORTH);
		...
		panel_Preview.add(panel, BorderLayout.CENTER);
		...
		panel_Preview.add(panel_4, BorderLayout.SOUTH);
		panel_4.setLayout(new BorderLayout(0, 0));

		JPanel panel_19 = new JPanel();
		panel_4.add(panel_19, BorderLayout.CENTER);
		panel_19.setLayout(new GridLayout(2, 3, 30, 0));
		...
		btnNewButton_Start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Thread t3 = new Thread(controller_cam);
				t3.start();
			}
		});
		...
		panel_Parameter2.add(panel_parameter);
		...
		JButton btnNewButton_well_add = new JButton("Add");
		btnNewButton_well_add.setBackground(Color.CYAN);
		panel1.add(btnNewButton_well_add);
		btnNewButton_well_add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		JButton btnNewButton_Start2 = new JButton("                Start                ");
		btnNewButton_Start2.setBackground(Color.GREEN);
		panel_Start_Stop.add(btnNewButton_Start2);

		btnNewButton_Start2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_rep.getText().isEmpty()) {
		...
		JButton btnNewButton_Stop2 = new JButton("Stop");
		btnNewButton_Stop2.setForeground(Color.BLACK);
		btnNewButton_Stop2.setBackground(Color.PINK);
		panel_Start_Stop.add(btnNewButton_Stop2);

		btnNewButton_Stop2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				protocol.stop();
			}
		});
