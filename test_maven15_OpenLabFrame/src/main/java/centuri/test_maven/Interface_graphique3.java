...
public class Interface_graphique3 extends JFrame {
	...
	public Interface_graphique3() {
		...
		lblNewLabel_Time_break.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		lblNewLabel_Time_Video.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		lblNewLabel_volume_i.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_volume_i.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		lblNewLabel_volume_a.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_volume_a.setFont(new Font("Dialog", Font.BOLD, 10));
