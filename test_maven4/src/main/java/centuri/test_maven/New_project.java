...
public class New_project extends JFrame {
	...
	public New_project() {
		...
		panel_1.add(btnButton_B3);
				...
				JComboBox comboBox_Time1 = new JComboBox(message_encoT);
				panel_Heigth.add(comboBox_Time1);
				comboBox_Time1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						System.out.println(comboBox_Time1.getSelectedItem().toString());
					}
				});
				...
				btnButton_Back_1_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						dispose();
					}
				});
		...
		// Button Stop //
				...
				btnButton_Back_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						dispose();
					}
				});
